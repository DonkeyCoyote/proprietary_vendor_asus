...
PRODUCT_COPY_FILES := \
    ...
    vendor/asus/deb/qcom/eglsubAndroid.so:system/vendor/lib/egl/eglsubAndroid.so:qcom \
    vendor/asus/deb/qcom/libEGL_adreno.so:system/vendor/lib/egl/libEGL_adreno.so:qcom \
    vendor/asus/deb/qcom/libGLESv1_CM_adreno.so:system/vendor/lib/egl/libGLESv1_CM_adreno.so:qcom \
    vendor/asus/deb/qcom/libGLESv2_adreno.so:system/vendor/lib/egl/libGLESv2_adreno.so:qcom \
    vendor/asus/deb/qcom/libplayback_adreno.so:system/vendor/lib/egl/libplayback_adreno.so:qcom \
    vendor/asus/deb/qcom/libq3dtools_adreno.so:system/vendor/lib/egl/libq3dtools_adreno.so:qcom \
    ...
    vendor/asus/deb/qcom/libadreno_utils.so:system/vendor/lib/libadreno_utils.so:qcom \
    ...
    vendor/asus/deb/qcom/libC2D2.so:system/vendor/lib/libC2D2.so:qcom \
    vendor/asus/deb/qcom/libc2d30-a3xx.so:system/vendor/lib/libc2d30-a3xx.so:qcom \
    vendor/asus/deb/qcom/libc2d30.so:system/vendor/lib/libc2d30.so:qcom \
    vendor/asus/deb/qcom/libCB.so:system/vendor/lib/libCB.so:qcom \
    ...
    vendor/asus/deb/qcom/libgsl.so:system/vendor/lib/libgsl.so:qcom \
    ...
    vendor/asus/deb/qcom/libllvm-qcom.so:system/vendor/lib/libllvm-qcom.so:qcom \
    ...
    vendor/asus/deb/qcom/librs_adreno_sha1.so:system/vendor/lib/librs_adreno_sha1.so:qcom \
    vendor/asus/deb/qcom/librs_adreno.so:system/vendor/lib/librs_adreno.so:qcom \
    vendor/asus/deb/qcom/libRSDriver_adreno.so:system/vendor/lib/libRSDriver_adreno.so:qcom \
    vendor/asus/deb/qcom/libsc-a3xx.so:system/vendor/lib/libsc-a3xx.so:qcom \
